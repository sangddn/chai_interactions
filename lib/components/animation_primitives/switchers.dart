// Copyright 2024 Sang Doan
//
// A collection of animated switcher widgets that smoothly transition between
// different child widgets.
//
// A switcher is a widget that animates the transition when its child widget changes.
// When the child widget is replaced with a new one, the switcher automatically
// animates out the old child and animates in the new child using the specified
// transition effects.
//
// This file includes several types of switchers:
// * [FlipSwitcher] - Animates with a 3D flip effect around X or Y axis
// * [TranslationSwitcher] - Slides widgets in/out in different directions
// * [SizeSwitcher] - Animates size changes with optional blur and scale effects
// * [FadeSwitcher] - Simple fade transition between widgets
// * [ScaleBlurSwitcher] - Combines scaling and blur effects
//
// Each switcher can be customized with different durations, curves, and
// transition parameters to achieve the desired animation effect.
...
const _shortDuration = Duration(milliseconds: 250);
const _mediumDuration = Duration(milliseconds: 500);

/// Switcher with flip transition
class FlipSwitcher extends AnimatedSwitcher {
  /// Switcher with flip transition around x axis
  FlipSwitcher.flipX({
    super.duration = _mediumDuration,
